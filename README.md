...
| Document                                                                        | Purpose                                                                                              |
| ------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| [14 - final-report.md](docs/14%20-%20final-report.md)                           | **Submission report** — requirements, bonuses, limitations, decisions, test results, evaluator notes |
...
| Document                                      | Purpose                                                                                                                            |
| --------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| [ai-conversation.md](docs/ai-conversation.md) | The full Claude Code session that produced this solution (challenge requirement #2); generated by `scripts/export-conversation.ts` |
...
| `GET`    | `/events/{id}`        | —                          | `200` / `404`           | Read back a published event (events are immutable)   |
...
`/deliveries`, CloudFormation, recovery, structured logging, OpenAPI). Remaining
items are the production follow-ups above.

- **Submission report:** [docs/14 - final-report.md](docs/14%20-%20final-report.md) — release check + requirements / bonuses / limitations / decisions / test results.
- **Per-step decision record:** [docs/9 - decisions.md](docs/9%20-%20decisions.md).
- **AI session:** [docs/ai-conversation.md](docs/ai-conversation.md).
